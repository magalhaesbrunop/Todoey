...
extension TodoListViewController: UISearchBarDelegate {
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        //let predicate = NSPredicate(format: "title CONTAINS %@", _searchBar.text!)
        let categoryPredicate = NSPredicate(format: "title CONTAINS[cd] %@", searchBar.text!)
        //request.predicate = predicate
        
        let compoundPredicare = NSCompoundPredicate(andPredicateWithSubpredicates: [categoryPredicate])
